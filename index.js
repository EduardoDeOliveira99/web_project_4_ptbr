...
function createCard(name, link) {
   ...
   favIcon.addEventListener("click", () => favIcon.classList.toggle('grid__element__fav-icon_active'));
   ...
   gridImage.addEventListener('click', function() {
      ...
      modalImage.src = link;
      const modalDescription = document.querySelector(".photos__modal__description");
